...
class MainActivity : AppCompatActivity() {
    ...
    private fun recordMove(view: View) {
        ...
        val player_one=findViewById<EditText>(R.id.player_one)
        val player_two:EditText=findViewById(R.id.player_two)

        val player_one_label:TextView=findViewById(R.id.player_one_label)
        val player_two_label:TextView=findViewById(R.id.player_two_label)
    ...
    private fun togglePlayerTurn(playerOn : TextView, playerOff : TextView){
        ...
        playerOn.setTextColor(ContextCompat.getColor(this, R.color.light_red))
